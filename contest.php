...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <?php } ?>
            <form method="post" action="server/contest_process.php" class="border p-4" enctype="multipart/form-data">
                <div class = "row">
                    <div class = "col-md-6">
                        <!-- File Input Group -->
                    ...
                    <div class = "col-md-6">
                        <div class="form-group">
                            <label for="file2" class="d-block">Upload Image</label>
                            <input type="file" accept="image/*" name="image2" id="file2" onchange="loadFile2(event);" class="form-control-file" required>
                        </div>

                        <!-- Image Preview -->
                        <div class="form-group">
                            <img id="output2" width="200" height= "200px" class="img-thumbnail" />
                        </div>
